...
//        Log.d(TAG, notifyString);
    	...
    	String MY_PKG_NAME = "com.yzh.rfidbike_police";
...
//        pushMessage.setReferenceId("1");
        ...
        intent.setClass(context.getApplicationContext(), MainNewActivity.class);
...
////            bundle.putSerializable("EventBusMsgPush",pushMessage);
...
//        updateContent(context);
    ...
    private void updateContent(Context context) {
        Intent intent = new Intent();
        intent.setClass(context.getApplicationContext(), MessageCenterPoliceActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        context.getApplicationContext().startActivity(intent);
    }
